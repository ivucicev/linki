  ...
  const rows = db.prepare(`
    SELECT rt.id, rt.pending_message, rt.pending_subject, rt.track,
           ...
           COALESCE((SELECT COUNT(*) FROM workflow_steps ws2
            ...
            AND ws2.step_order <= ws.step_order), 1) as step_number,
    ...
    LEFT JOIN workflow_steps ws ON ws.workflow_id = r.workflow_id AND ws.track = rt.track AND ws.step_order = rt.current_step + 1
